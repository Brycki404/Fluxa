...
local controller = FluxaController.new({
    ...
    Tracks = {
        ...
        Walk  = { Asset = assets.Walk,  Layer = "Base",    TrackOptions = { Looped = true } },
        Run   = { Asset = assets.Run,   Layer = "Base",    TrackOptions = { Looped = true } },
        Land  = { Asset = assets.Land,  Layer = "Landing", TrackOptions = { Looped = false }, AutoReplicate = true, ReplicationSeekMode = "Never" },
    },
