...
Fluxa.FluxaReplicationService = require(script.Fluxa.Replication.FluxaReplicationService)
...
Fluxa.Replication = {}
Fluxa.Replication.FluxaReplicationService = Fluxa.FluxaReplicationService
