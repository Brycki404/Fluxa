...
export type AnimationTrackInstance = {
	...
	Play: (self: AnimationTrackInstance, fadeInTime: number?) -> nil,
...
function AnimationTrack.Play(self: AnimationTrackInstance, fadeInTime: number?)
